...
authApp.controller('AuthenticationCtrl', function($scope, $http, $location, AppSettings, StoreLoginData) {
...
authApp.factory('Logout', function($window, $location, $http, AppSettings) {
    var rails_server_path = AppSettings.apiUrl;
    return function() {
        $http({
            headers: {
